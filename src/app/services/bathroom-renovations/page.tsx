...
export const metadata: Metadata = {
  title: "Bathroom Renovations Auckland | JRA Construction",
  description:
    "Transform your bathroom into a stunning sanctuary with JRA Construction. Expert Auckland bathroom renovations — fixed-price contracts, waterproofing certified.",
};
