...
export const metadata: Metadata = {
  title: "Home Extensions Auckland | JRA Construction",
  description:
    "Expert home extensions in Auckland by JRA Construction. Add space to your home without moving — fixed-price contracts, 10-year Master Builders guarantee.",
};
