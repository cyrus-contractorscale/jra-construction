...
export const metadata: Metadata = {
  title: { absolute: "Lucinda Place, Glen Eden | JRA Construction in Auckland" },
  description:
    "JRA Construction is proud to collaborate with Guman Developer Ltd and Tarzan Design on the Lucinda Place project in Glen Eden. Contact us now to learn more.",
  alternates: { canonical: "/projects/lucinda-place-glen-eden" },
};
