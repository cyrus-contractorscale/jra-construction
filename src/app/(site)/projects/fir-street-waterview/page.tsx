...
export const metadata: Metadata = {
  title: { absolute: "Fir Street, Waterview | JRA Construction in Auckland" },
  description:
    "JRA Construction partnered with Hoxha Bailey Architects to revitalize the Fir Street dwelling in Waterview. Learn more about the transformed living area now.",
  alternates: { canonical: "/projects/fir-street-waterview" },
};
        ...
        <Container className="grid gap-12 lg:grid-cols-2 lg:gap-16">
          <AnimateOnScroll variant="fade-right">
            <div className="space-y-5">
              ...
              <p className="text-[17px] font-semibold text-[#293a57]">NATIONAL AWARDS WON: Top 100</p>
            </div>
          </AnimateOnScroll>
