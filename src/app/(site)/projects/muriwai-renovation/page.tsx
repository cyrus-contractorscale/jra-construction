...
export const metadata: Metadata = {
  title: { absolute: "Muriwai Renovation | JRA Construction in Auckland" },
  description:
    "JRA Construction undertook a renovation project in Muriwai, enhancing the property's outdoor spaces. To learn more about our projects, visit our website.",
  alternates: { canonical: "/projects/muriwai-renovation" },
};
