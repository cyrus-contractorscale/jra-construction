...
export const metadata: Metadata = {
  title: { absolute: "Te Wiata Place, Avondale | JRA Construction in Auckland" },
  description:
    "JRA Construction collaborated with Drawn Architects to undertake a transformative extension and renovation project on Te Wiata Place in Avondale.",
  alternates: { canonical: "/projects/te-wiata-place-avondale" },
};
