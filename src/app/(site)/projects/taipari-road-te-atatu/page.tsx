...
export const metadata: Metadata = {
  title: { absolute: "Taipari Road and Te Atatu Home Project | JRA Construction" },
  description:
    "JRA Construction transformed this Taipari Road, Te Atatu property through expert external reclad and renovation. View our building projects.",
  alternates: { canonical: "/projects/taipari-road-te-atatu" },
};
