...
const projects = [
  {
    title: "Mcleod Road, Te Atatu",
    body: "The Mcleod Road, Te Atatu development focuses on building a new residential project guided by the design direction of Mercury Architecture.",
    image: "/projects/mcleod-road-te-atatu/McleodRD-77-scaled.jpg",
    href: "/projects/mcleod-road-te-atatu",
  },
  {
    title: "Cleve Road, Green Bay",
    body: "This Green Bay development features eight modern townhouses—six 2-bedroom units and two 3-bedroom units, with garages for the larger homes.",
    image: "/projects/cleve-road-green-bay/15_cleve_day_hr-25-scaled.jpg",
    href: "/projects/cleve-road-green-bay",
  },
  {
    title: "Hurstmere Road",
    body: "The Hurstmere Road project delivers a full interior fitout designed to support Valvaere’s brand and operational needs.",
    image: "/projects/hurstmere-road/Hurstmere.png",
    href: "/projects/hurstmere-road",
  },
  {
    title: "Queensway",
    body: "Designed by ICR Studio for Avi and Neetha, these new builds are clean, practical, and built for everyday living.",
    image: "/projects/queensway/Living-1-_-Kitchen.jpg",
    href: "/projects/queensway",
  },
  {
    title: "North Piha Road",
    body: "JRA Construction worked with clients John and Sarah to breathe new life into their North Piha bach.",
    image: "/projects/north-piha-road/JRAPHIA-44-scaled.jpg",
    href: "/projects/north-piha-road",
  },
  {
    title: "Seacombe Road, Point Chevalier",
    body: "Keren & Becki wanted to transform their Seacombe Road home in Point Chevalier into a modern, functional space for their family.",
    image: "/projects/seacombe-road-point-chevalier/Seacombe-11-scaled.jpg",
    href: "/projects/seacombe-road-point-chevalier",
  },
  {
    title: "KhuKhu Milford",
    body: "This restaurant fitout project transformed a Milford space into the latest KhuKhu vegan Thai eatery.",
    image: "/projects/khukhu-milford/khukhumilford-1.jpg",
    href: "/projects/khukhu-milford",
  },
  {
    title: "Matakana",
    body: "This Matakana project involved renovating and extending a family home to create a more open layout and add a master bedroom suite with a walk-in wardrobe.",
    image: "/projects/matakana/Matakana-Exterior-2-scaled.jpg",
    href: "/projects/matakana",
  },
  {
  ...
  {
    title: "Laingholm Baptist Church",
    body: "This transformative new build and renovation project at Laingholm Baptist Church was brought to life through the collaboration of JRA Construction and SGA Architects Ltd.",
    image: "/projects/laingholm-baptist-church/Laingholm-Baptist-Church1.jpg",
    href: "/projects/laingholm-baptist-church",
  },
  {
    title: "Bellevue",
    body: "This Bellevue project was a full renovation and extension of a 1980s family home for clients Steve and Emma, with designs by Four Walls Architecture.",
    image: "/projects/bellevue/JRA-Belle-Vue-Website-Ready-2.jpg",
    href: "/projects/bellevue",
  },
  {
    title: "Mount Eden Renovation",
    body: "This Mount Eden project involved a full renovation of an existing family home aimed at improving flow, comfort, and style.",
    image: "/projects/mount-eden-renovation/DJI_0938-HDR-1-sharpen-scaled.jpg",
    href: "/projects/mount-eden-renovation",
  },
  {
    title: "Saint Leonards Road, Mount Eden",
    body: "Saint Leonards Road, Mount Eden project is a remarkable villa extension and renovation undertaken by JRA Construction in partnership with the esteemed Logan Architects.",
    image: "/projects/saint-leonards-road-mount-eden/JRA-15-Saint-Leonards-Website-151.jpg",
    href: "/projects/saint-leonards-road-mount-eden",
  },
  {
              ...
              <AnimateOnScroll key={project.title} variant="fade-up" delay={index * 65}>
                <article className="group flex h-full flex-col overflow-hidden rounded-[18px] border border-[#e8edf2] bg-white shadow-[0_4px_24px_rgba(41,58,87,0.06)] transition duration-300 hover:-translate-y-1.5 hover:shadow-[0_16px_40px_rgba(41,58,87,0.12)]">
                  <div className="relative block aspect-[5/3] w-full overflow-hidden">
                    ...
                    />
                    <span className="absolute right-3 top-3 rounded-full bg-[#293a57] px-3 py-1 text-[11px] font-bold uppercase tracking-wide text-white">
                      View Project →
                    </span>
                  </div>
                  <div className="flex flex-1 flex-col px-5 pb-6 pt-5 sm:px-6">
                    <h3 className="text-[1.1rem] font-bold leading-snug text-[#293a57] sm:text-[1.2rem]">
                      {project.title}
                    </h3>
