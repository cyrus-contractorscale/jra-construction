...
export const metadata: Metadata = {
  title: { absolute: "Gunson Street, Freemans Bay | JRA Construction in Auckland" },
  description:
    "JRA Construction handled an internal and external renovation project on Gunson Street, Freemans Bay. Visit our website to learn more about this project.",
  alternates: { canonical: "/projects/gunson-street-freemans-bay" },
};
