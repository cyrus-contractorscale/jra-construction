...
export const metadata: Metadata = {
  title: { absolute: "Westminster Road, Balmoral | JRA Construction in Auckland" },
  description:
    "JRA Construction partnered with Spooner Architectural to transform this Westminster Road residence in Balmoral. View our project details.",
  alternates: { canonical: "/projects/westminster-road-balmoral" },
};
