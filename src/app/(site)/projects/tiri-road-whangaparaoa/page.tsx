...
export const metadata: Metadata = {
  title: { absolute: "Tiri Road, Whangaparāoa | JRA Construction in Auckland" },
  description:
    "JRA Construction created a stunning new build project on Tiri Road, Whangaparāoa. Learn more about its exceptional design by contacting us.",
  alternates: { canonical: "/projects/tiri-road-whangaparaoa" },
};
        ...
        <Container className="grid gap-12 lg:grid-cols-2 lg:gap-16">
          <AnimateOnScroll variant="fade-right">
            <div className="space-y-5">
              ...
              <p className="text-[17px] font-semibold text-[#293a57]">REGIONAL AWARDS WON: Regional Silver</p>
            </div>
          </AnimateOnScroll>
