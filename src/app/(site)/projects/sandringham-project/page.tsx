...
export const metadata: Metadata = {
  title: { absolute: "Sandringham Project | JRA Construction in Auckland" },
  description:
    "JRA Construction partnered with Harbour City Plans to transform this Sandringham residence. Contact us to learn about our building expertise.",
  alternates: { canonical: "/projects/sandringham-project" },
};
