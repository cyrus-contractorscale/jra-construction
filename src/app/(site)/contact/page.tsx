        ...
        <Container className="max-w-[1200px] grid gap-10 lg:grid-cols-2 lg:gap-14">
          ...
          <AnimateOnScroll variant="fade-right">
            <div className="space-y-6 text-[#4d6277]">
              <p className="text-[16px] leading-relaxed">
                Get in touch with our Auckland building team for expert advice and a free
                consultation on your custom home, renovation, or extension project.
              </p>
              <AnimateOnScroll variant="fade-up" delay={80}>
                <div className="flex items-start space-x-3">
                  <IconMapPin className="mt-0.5 h-6 w-6 shrink-0 text-[#293a57]" />
                  <div className="space-y-1">
                    <h3 className="font-bold text-[#293a57]">Address:</h3>
              ...
              <AnimateOnScroll variant="fade-up" delay={160}>
                <div className="flex items-start space-x-3">
                  <IconPhone className="mt-0.5 h-6 w-6 shrink-0 text-[#293a57]" />
                  <div className="space-y-1">
                    <h3 className="font-bold text-[#293a57]">Phone:</h3>
                    <p>021 276 9971</p>
                  </div>
                </div>
              </AnimateOnScroll>
              <AnimateOnScroll variant="fade-up" delay={240}>
                <div className="flex items-start space-x-3">
                  <IconEmail className="mt-0.5 h-6 w-6 shrink-0 text-[#293a57]" />
                  <div className="space-y-1">
                    <h3 className="font-bold text-[#293a57]">Email:</h3>
                    <p>joe@jraconstruction.co.nz</p>
                  </div>
                </div>
              </AnimateOnScroll>
            </div>
          ...
          <AnimateOnScroll variant="fade-left" delay={100}>
            <div className="space-y-6">
              <h2 className="font-[ui-sans-serif,system-ui,sans-serif] text-3xl font-extrabold leading-tight tracking-tight text-[#293a57] sm:text-4xl">
                Send Us A Message
              </h2>
              <form className="space-y-4">
                <AnimateOnScroll variant="fade-up" delay={150}>
                  <div>
                    ...
                    <input type="text" id="name" name="name" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#293a57] focus:ring-[#293a57] sm:text-sm" />
                  </div>
                </AnimateOnScroll>
                <AnimateOnScroll variant="fade-up" delay={220}>
                  <div>
                    <label htmlFor="email" className="block text-sm font-medium text-[#4d6277]">Email</label>
                    <input type="email" id="email" name="email" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#293a57] focus:ring-[#293a57] sm:text-sm" />
                  </div>
                </AnimateOnScroll>
                <AnimateOnScroll variant="fade-up" delay={290}>
                  <div>
                    <label htmlFor="message" className="block text-sm font-medium text-[#4d6277]">Message</label>
                    <textarea id="message" name="message" rows={4} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#293a57] focus:ring-[#293a57] sm:text-sm"></textarea>
                  </div>
                </AnimateOnScroll>
                <AnimateOnScroll variant="fade-up" delay={360}>
                  <button type="submit" className="inline-flex items-center justify-center rounded-full bg-[#293a57] px-7 py-3 text-sm font-semibold text-white shadow-lg shadow-black/30 transition hover:bg-[#1e2d47]">
                    Submit
                  </button>
                </AnimateOnScroll>
              </form>
