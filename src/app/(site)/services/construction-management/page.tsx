...
/* All copy on this page is verbatim from the live site
   (jraconstruction.co.nz/services/construction-management/). */
...
const jraAdvantage = [
  ...
  "Virtual walkthroughs of progress",
...
const faqs = [
  { q: "How do you prevent cost overruns?", a: "We use earned value management (EVM) principles and transparent variation order systems to maintain financial control." },
  { q: "What’s included in daily management?", a: "Our supervisors handle site coordination, safety auditing, and progress recording within construction management software." },
  { q: "Do you handle council inspections?", a: "Yes, we manage all inspection requests and documentation through Auckland Council’s online consent portal." },
  { q: "What happens if issues arise?", a: "We activate our risk mitigation and incident response protocols, maintaining project continuity." },
];
  ...
  return (
    <>
          ...
          <AnimateOnScroll variant="fade-left" delay={150}>
            <div className="space-y-5">
              <p className="text-[17px] leading-[1.65] text-[#4d6277]">
                Building a home or renovating in Auckland demands precise coordination, reliable
                communication, and technical expertise. At JRA Construction, we provide comprehensive
                construction project administration, managing every phase of your build to prevent
                delays, cost overruns, and quality issues. Our end-to-end construction management
                framework ensures seamless execution—from concept design development to the final code
                compliance inspection—so you can enjoy a stress-free experience and a finished result
                that meets NZ Building Code standards.
              </p>
              <div className="flex flex-wrap gap-3 pt-2">
        ...
        <Container className="grid gap-12 lg:grid-cols-2 lg:items-center lg:gap-16">
          <AnimateOnScroll variant="fade-right">
            <div className="space-y-5">
              ...
              <p className="text-[16px] leading-[1.7] text-[#4d6277]">
                Professional construction project management transforms complex builds into organised,
                goal-driven operations. Our team coordinates architectural consultants, structural
                engineers, subcontractors, and suppliers while maintaining site safety and quality
                assurance protocols. Through real-time construction scheduling software and critical
                path monitoring, we maintain rigorous oversight of each project phase to keep delivery
                aligned with your scope and timeline.
              </p>
              <p className="text-[16px] leading-[1.7] text-[#4d6277]">
                Your dedicated project manager becomes your single point of accountability, overseeing
                procurement workflows, council compliance milestones, and progress tracking through
                Gantt chart updates. We maintain transparency with budget variance reporting, digital
                site records, and structured communication channels, ensuring every decision and
                adjustment is logged, approved, and traceable.
              </p>
              <p className="text-[16px] leading-[1.7] text-[#4d6277]">
                Our expertise in construction and project management spans renovations, home
                extensions, and new builds across Auckland&apos;s diverse neighbourhoods. Whether
                you&apos;re adding a master suite or constructing a full-scale architectural residence,
                our systematic coordination framework ensures consistency, efficiency, and adherence to
                NZ construction best practice standards from concept through completion
              </p>
              <Link
                href="/estimate"
          ...
          <AnimateOnScroll variant="fade-left" delay={150}>
            <div className="relative aspect-[3/2] overflow-hidden rounded-2xl shadow-xl shadow-[#293a57]/15">
              <Image
                src="/services/laingholm-pavilion-evening-1024x683.jpg"
        ...
        <Container className="grid gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <AnimateOnScroll variant="fade-left" delay={150}>
            <div className="space-y-5">
              ...
              <p className="text-[16px] leading-[1.65] text-[#4d6277]">
                This framework protects your investment by combining technical precision with
        ...
        <Container className="grid gap-12 lg:grid-cols-2 lg:items-center lg:gap-16">
          <AnimateOnScroll variant="fade-right">
            <div className="relative aspect-[1024/536] overflow-hidden rounded-2xl shadow-xl shadow-[#293a57]/15">
              <Image
                src="/services/taipari-road-te-atatu07-673a8cab8f4c5-1-1024x536.webp"
                alt="Suburban Residence Exterior"
                fill
                className="object-cover"
                sizes="(max-width: 1024px) 100vw, 50vw"
              />
          ...
          <AnimateOnScroll variant="fade-left" delay={150}>
            <div className="space-y-5">
              ...
              <p className="text-[17px] leading-[1.65] text-[#4d6277]">
                Effective oversight requires disciplined site logistics coordination, work sequencing,
                and continuous safety management in accordance with Site Safe NZ protocols. Our
                supervisors document progress daily, enforce construction methodology compliance, and
                manage communication through RFI (Request for Information) and site diary systems.
              </p>
              <p className="text-[17px] leading-[1.65] text-[#4d6277]">
                From pre-construction to handover, we integrate all phases into a cohesive construction
                lifecycle management system that emphasises risk mitigation, cost control, and
        ...
        <Container className="mx-auto max-w-4xl space-y-6">
          ...
          <AnimateOnScroll variant="fade-up" delay={100} className="space-y-5">
            <p className="text-[17px] leading-[1.7] text-[#4d6277]">
              ...
              supported by supplier performance metrics and just-in-time delivery scheduling, to
              maintain project momentum.
            </p>
            <p className="text-[17px] leading-[1.7] text-[#4d6277]">
              We identify risks early through project risk registers and address them before they
              impact the schedule or budget. Every element—from procurement schedules to defect
              rectification checklists—is verified through structured QA/QC workflows.
            </p>
            <p className="text-[17px] leading-[1.7] text-[#4d6277]">
              Quality control extends beyond materials and workmanship to include schedule adherence,
              financial forecasting, and stakeholder communication protocols. This proactive approach
              has earned JRA Construction recognition across Auckland&apos;s building industry.
            </p>
          </AnimateOnScroll>
        </Container>
      </section>
        ...
        <Container className="space-y-8">
          <AnimateOnScroll variant="fade-up" className="mx-auto max-w-3xl text-center space-y-4">
            ...
            <p className="text-[17px] leading-[1.7] text-[#5f7286]">
              At JRA Construction, every project operates within a clearly defined construction
              management methodology designed to ensure consistency, transparency, and accountability
              across all stages of delivery. We apply industry-recognised project governance
              frameworks, including PMBOK-aligned planning principles, risk management registers, and
              QA/QC verification protocols tailored to New Zealand&apos;s construction environment.
            </p>
            <p className="text-[17px] leading-[1.7] text-[#5f7286]">
              Our management process incorporates critical path scheduling (CPS), earned value
              management (EVM), and construction phase monitoring using cloud-based platforms such as
              Procore and Buildertrend. This allows for precise tracking of resources, budget
              variances, and performance metrics throughout the project lifecycle.
            </p>
            <p className="text-[17px] leading-[1.7] text-[#5f7286]">
              Compliance is central to our approach. All projects are delivered under the oversight of
              Licensed Building Practitioners (LBPs), adhere to the NZ Building Code (NZBC), and
              maintain complete alignment with Site Safe NZ safety standards and ISO 9001 quality
              assurance procedures. Our document control system ensures every design change, inspection
              report, and council correspondence is recorded for full project traceability and audit
              compliance.
            </p>
            <p className="text-[17px] leading-[1.7] text-[#5f7286]">
              This integrated methodology provides clients with measurable performance outcomes —
              predictable delivery, cost certainty, and verified quality at handover.
            </p>
            <Link
              href="/why-choose-us"
      ...
      <FeaturedGallery
        ...
        images={[
          { src: "/services/Copy-of-2A3A2941-scaled.jpg", alt: "Construction management project" },
          { src: "/services/Copy-of-2A3A2794-1024x683.jpg", alt: "Construction management build" },
          { src: "/services/Copy-of-2A3A2787-1024x683.jpg", alt: "Construction management interior" },
          ...
          { src: "/services/DSC00888-HDR-1-sharpen-1024x683.jpg", alt: "Completed construction project" },
        ]}
      />
