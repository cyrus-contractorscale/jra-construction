        ...
        <Container className="grid gap-12 lg:grid-cols-2 lg:gap-16 lg:items-center">
          <AnimateOnScroll variant="fade-right">
            <div className="space-y-5">
              <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#293a57]/50">Smart Space Solution</p>
          ...
          <AnimateOnScroll variant="fade-left" delay={150}>
            <div className="space-y-4">
              <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#293a57]/50">Why Consider Building a Minor Dwelling</p>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {keyPoints.map((point, i) => (
              <AnimateOnScroll key={point.title} variant="fade-up" delay={i * 80}>
                <div className="flex flex-col gap-4 rounded-2xl border border-[#e8edf2] bg-white p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-md hover:shadow-[#293a57]/8">
                  <span className="text-4xl">{point.icon}</span>
                  <h3 className="text-[17px] font-bold text-[#293a57]">{point.title}</h3>
