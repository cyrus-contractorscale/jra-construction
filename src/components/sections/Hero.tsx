...
export function Hero() {
  ...
  return (
    <section
      id="top"
      ref={heroRef}
      className="relative isolate flex min-h-screen items-center overflow-hidden bg-zinc-900"
    >
      ...
      <div className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-zinc-950/45 backdrop-blur-sm">
        <Container className="grid h-16 grid-cols-[1fr_auto_1fr] items-center text-white lg:h-20">
          ...
          <Link href="#top" className="block justify-self-center">
            <Image
          ...
          <Link
            href="#contact"
            className="justify-self-end rounded-full border border-white/35 px-4 py-2 text-[14px] font-semibold text-white transition hover:bg-white/10 lg:px-6"
          >
            Online Estimate
          </Link>
        </Container>
