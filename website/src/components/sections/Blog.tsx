    ...
    <section id="blog" className="scroll-mt-24 bg-[#f9fafb] py-16 sm:py-20">
      <Container>
        <div className="flex flex-col gap-8 lg:flex-row lg:items-start lg:justify-between lg:gap-10">
          ...
          <Link
            href="#"
            className="inline-flex shrink-0 items-center justify-center self-start rounded-xl border border-[#cfd8e2] bg-white px-5 py-2.5 text-[15px] font-medium text-[#6b7c8f] shadow-sm transition hover:border-[#b8c5d3] hover:text-[#0f2744] lg:mt-2"
          >
            View All Blogs
          </Link>
        </div>
